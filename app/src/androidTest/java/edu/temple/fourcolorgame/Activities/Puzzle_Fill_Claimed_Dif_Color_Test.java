...
public class Puzzle_Fill_Claimed_Dif_Color_Test {
    Context context;
    ...
    @Test
    public void fill_in_dif_color_region_single_mode() throws Exception {
        ...
        boolean validMove = board.isValidMove(p, colors[1], Intents.puzzle);
